...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    # Post-run report digest: one extra quick-model call that distills the
    # transcripts into the curated summary layer report surfaces render
    # (thesis + evidence bullets, risk stances, conviction, exit triggers).
    # Optional decoration — failures never fail the run.
    "report_digest": True,
